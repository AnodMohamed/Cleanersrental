                            ...
                            <li class="dropdown flags">
                                @if(Route::has('login'))
                                    @auth
                                        ...
                                        @elseif (Auth::user()->utype == 'CLE')
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> User : ({{ Auth::user()->name }})  <i class="fa fa-angle-down"></i></a>
                                            <ul role="menu" class="dropdown-menu">
                                                <li><a href="{{ route('cleaner.dashboard') }}">Dashboard</a></li>
                                                <li><a href="{{ route('logout') }}"  onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logouut </a></li>
                                                <form id="logout-form" method="POST" action="{{ route('logout') }}">
                                                    @csrf
                                                </form>
                                            </ul>
                                         @elseif (Auth::user()->utype == 'COMP')
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> User : ({{ Auth::user()->name }})  <i class="fa fa-angle-down"></i></a>
                                            <ul role="menu" class="dropdown-menu">
        ...
        <div class="footer-meta">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="copyright">Copyright 2014Cleanersrental |   All Rights Reserved   |   Designed By Jthemes</div>
                    </div>
                    <div class="col-sm-6">
						{{---
                        <div class="payments">
